...
public class Tomcat10Configurator extends WebContainerConfigurator<Tomcat> {

    private Tomcat tomcat;
    private HazelcastSessionManager manager;
    private String appName;

    public Tomcat10Configurator(String appName) {
        this.appName = appName;
    }

    public Tomcat10Configurator() {
    ...
    public Tomcat configure() throws Exception {
        ...
        final String cleanedRoot = URLDecoder.decode(root.getFile(), UTF_8);
